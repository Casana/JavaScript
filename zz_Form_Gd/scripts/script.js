class Formulario {
    ...
    sacarTextos() {
        this.fSalida = [
            ...
            { etiqueta: "Contrase̱a", valor: this.fContrasena.value },
    ...
    diaHoy() {
        ...
        document.getElementById("systemDate").innerHTML = "Hoy es " + " " + dias[hoy.getDay()] + " " + "dia" + " " + hoy.getDate() + " " + "de" + " " + meses[hoy.getMonth()] + " " + "del a̱o" + " " + hoy.getFullYear();
    }
    chBox() {
        let aficiones = ""
